...
public class ClienteService(IClienteRepository repository, IUnitOfWork unitOfWork, ILogger<CrudService<Cliente, IClienteRepository, IUnitOfWork>> logger)
    : CrudService<Cliente, IClienteRepository, IUnitOfWork>(repository, unitOfWork, logger), IClienteService
{
