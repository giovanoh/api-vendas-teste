...
public class VendaService(IVendaRepository repository, IUnitOfWork unitOfWork, ILogger<CrudService<Venda, IVendaRepository, IUnitOfWork>> logger)
    : CrudService<Venda, IVendaRepository, IUnitOfWork>(repository, unitOfWork, logger), IVendaService
{
